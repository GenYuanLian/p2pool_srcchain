...
#            header_has = bitcoin_data.hash256(bitcoin_data.block_header_type.pack(header))
            header_hash = self.node.net.PARENT.POW_FUNC(bitcoin_data.block_header_type.pack(header))
            pow_hash    = self.node.net.PARENT.POW_FUNC(bitcoin_data.block_header_type.pack(header))
            tes_hash    = bitcoin_data.hash256(bitcoin_data.block_header_type.pack(header))
            try:
