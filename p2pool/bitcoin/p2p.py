...
HHPOW_FUNC = lambda data: pack.IntType(256).unpack(__import__('Lyra2Z_scrypt').getPoWHash(data))
...
#            self.get_block_header.got_response(bitcoin_data.hash256(bitcoin_data.block_header_type.pack(header)), header)
            self.get_block_header.got_response(HHPOW_FUNC(bitcoin_data.block_header_type.pack(header)), header)
